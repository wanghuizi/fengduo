  ...
  ImageButton.prototype._initUploader = function($uploadItem) {
    ...
    createInput = (function(_this) {
      return function() {
        ...
        return $input = $('<input type="file" name="upload" title="' + _this._t('uploadImage') + '" accept="image/*">').appendTo($uploadItem);
      };
    })(this);
    createInput();
  ...
  ImagePopover.prototype._initUploader = function() {
    ...
    createInput = (function(_this) {
      return function() {
        ...
        return _this.input = $('<input type="file" name="upload" title="' + _this._t('uploadImage') + '" accept="image/*">').appendTo($uploadBtn);
      };
    })(this);
    createInput();
