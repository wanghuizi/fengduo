 ...
 */
package com.fengduo.bee.commons.redis;
...
import com.fengduo.bee.commons.core.SpringContextAware;
import com.fengduo.bee.commons.util.ObjectUtils;
import com.fengduo.bee.commons.util.PropertiesLoader;
...
public class JedisUtils {
	...
	private static JedisPool jedisPool = SpringContextAware
			.getBean(JedisPool.class);

	private static PropertiesLoader loader = new PropertiesLoader(
			"redis.properties");

	public static final String KEY_PREFIX = loader
			.getProperty("redis.keyPrefix");
